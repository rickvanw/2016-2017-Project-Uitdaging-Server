...
var publicUrls = ["/user/add", "/user/password-reset-req", "/user/password-reset-confirm", "/user/login", "/user/change", "/user/password-reset-request", "/user/confirm-password-reset"];
